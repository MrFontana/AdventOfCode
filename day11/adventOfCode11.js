...
var increment = function(str) {
  ...
  return backToString(codeArr);
};
var checkRequirements = function(str) {
  if (str.match(/([iol])/)) {
    return false;
  } else if (str.match(/(([a-z])\2.*([a-z])\3)/)) {
