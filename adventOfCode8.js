...
var calculateCode = function() {
  for (var i = 0; i < input.length; i++) {
    var total2 = 0;
    total.code += input[i].length + 2;
    total2 = input[i].length + 2;
    console.log(total2);
  }
  return total.code;
};
...
var Sates = function(name) {
  this.name = name;
};

var california = new Sates('California');

Sates.prototype.name = 'Origon';

var something = new Sates('something');

console.log(california.name, something);
